...
<section class="mb-8">
  <div class="mb-6">
    ...
    <p class="mb-4">
      Find answers to common questions about Ekklesia, voting, wallets, and more. Use the search bar
      below to search for specific topics, or filter by tags to browse FAQs by category.
    </p>
    ...
    {#if data.tags && data.tags.length > 0}
      <div class="mb-4 flex flex-wrap gap-1">
        {#each data.tags as tag}
          <span
            class="cursor-pointer rounded-full border border-border bg-white px-2 py-0.5 text-xs text-foreground transition-opacity hover:opacity-80 {data.selectedTag ===
            tag
...
<Card.Root class="mb-16 mt-8">
  <Card.Header>
    <Card.Title>Still have questions?</Card.Title>
    <Card.Description>
      <p class="mb-4">
        If you couldn't find the answer you're looking for, please reach out to Intersect through
  ...
  <Card.Footer>
    <p class="text-sm text-muted-foreground">
      All polls on this platform are run by <a
        href="https://intersectmbo.org"
        target="_blank"
        class="link"
        rel="noopener noreferrer">Intersect</a
      >. For questions or issues related to voting, please refer to their official channels above.
    </p>
  </Card.Footer>
</Card.Root>
