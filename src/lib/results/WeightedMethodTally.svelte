    ...
    {#if hasData}
      <div class="mt-3 border-t pt-3">
          ...
          <thead>
            ...
            >
              ...
              <th class="py-2 text-right font-semibold">
                Mean <span class="font-normal normal-case tracking-normal"
                  >(per answering ballot)</span
                >
              </th>
        ...
        >
          ...
          <p>
            Mean counts voters who allocated 0 to this option. The parenthesized value is the
            contributors-only mean (`totalPoints / contributors`). Standard deviation shares the
            answering-ballot denominator, so a lot of zeros inflate variance relative to a
            contributors-only reading.
          </p>
        </div>
      </div>
    {/if}
