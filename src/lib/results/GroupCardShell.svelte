<script>
	...
	const powerPct = $derived(
		hasPowerDenom ? (group.activePower / group.totalVotingPower) * 100 : 0
	);
				...
				<div class="flex items-center gap-4 min-w-0">
					...
					<div class="space-y-2">
						...
						{#if !hasTurnoutDenom || (hasWeight && !hasPowerDenom)}
							<div class="text-[10px] italic uppercase tracking-wider text-muted-foreground">
