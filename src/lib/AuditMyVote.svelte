  ...
  <Card.Root class="mt-4">
    <Card.Header class="pb-3">
      ...
      <Card.Description class="text-xs">
        Save these artifacts if you want to independently verify that your vote is included in the
        final results. The Hydra Tx ID is an off-chain identifier from the voting head — it is not
        visible on a public Cardano explorer.
      </Card.Description>
    </Card.Header>
