    ...
    >
      ...
      <div class="flex-1">
        ...
        <p class="mt-0.5 text-xs">
          ...
          {:else}
            The voting period for this ballot has closed. The options below show what voters were
            asked.
          {/if}
        </p>
      </div>
      ...
      >
        ...
        <div class="flex-1">
          ...
          <p class="mt-0.5 text-xs text-slate-600">
            The options below are a preview. You need to sign in with an eligible wallet to cast
            your vote.
          </p>
        </div>
        <Button
