					...
					<li class="flex items-start gap-3 px-3 py-3">
						...
						<div class="min-w-0 flex-1">
							<div class="flex flex-wrap items-baseline gap-x-2">
								...
								{#if entry.narrativeOnly}
									<span class="rounded bg-sky-100 px-1.5 py-0.5 text-[10px] font-medium uppercase tracking-wider text-sky-800">
										Narrative-only
									</span>
								{/if}
								{#if entry.source === 'chain'}
									<span class="rounded bg-indigo-100 px-1.5 py-0.5 text-[10px] font-medium uppercase tracking-wider text-indigo-800">
										On-chain
									</span>
								{/if}
							</div>
