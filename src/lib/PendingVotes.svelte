...
<section class="mt-6" id="pending-votes">
  ...
  {#if draftBallots.length > 0}
    <p class="mb-4 text-sm text-muted-foreground">
      These drafts live in your browser until you sign and submit them on-chain. They don't leave
      this device — switch browsers or clear your storage and they're gone. Submit a ballot's votes
      through the broker below when you're ready to commit.
    </p>
