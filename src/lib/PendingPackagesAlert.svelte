...
{#if count > 0}
	...
	>
		...
		<p class="mb-2 text-xs">
			...
			them before the ballot closes, otherwise your vote won't count. Stale packages
			auto-expire after an hour of inactivity; use Discard to release the slot now.
		</p>
